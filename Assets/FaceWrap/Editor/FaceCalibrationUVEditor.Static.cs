...
{
    public partial class FaceCalibrationUVEditor
    {
    ...
    public partial class FaceCalibrationUVEditor
    {
        ...
        private void OnGUI()
        {
            ...
            position = new Rect(0, 0, width, width);
        ...
        private void ProcessWheelZoom(Rect viewRect)
        {
            ...
            if (evt.control || evt.type != EventType.ScrollWheel || !viewRect.Contains(evt.mousePosition))
            {
                return;
            }
        ...
        private void DrawViewSettings()
        {
            ...
            if (_foldoutViewSettings)
            {
                ...
                using (new EditorGUIIndentLevelScope())
                {
                    SerializedProperty mirrorXProp = _viewSettingsObject.FindProperty("_mirrorX");
                    SerializedProperty mirrorXCenterProp = _viewSettingsObject.FindProperty("_mirrorXCenter");
                    ...
                    mirrorXProp.boolValue = EditorGUILayout.Toggle("mirror X ", mirrorXProp.boolValue);
                    mirrorXCenterProp.floatValue = EditorGUILayout.Slider(
                        "mirror X Center",
                        mirrorXCenterProp.floatValue,
                        0.1f,
                        2f);
                    ...
                    if (EnableGeometryShader)
                    {
                        lineThicknessProp.floatValue = EditorGUILayout.Slider(
                            "Line Thickness",
                            lineThicknessProp.floatValue,
                            0.1f,
                            5f);
                    }
                    ...
                    vertexSizeProp.floatValue = EditorGUILayout.Slider("Vertex Size", vertexSizeProp.floatValue, 0.1f, 9f);
